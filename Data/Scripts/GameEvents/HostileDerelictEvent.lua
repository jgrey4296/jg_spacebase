...
function HostileDerelictEvent.allowEvent(nPopulation, nElapsedTime)
    return not g_Config:getConfigValue('disable_hostiles') and (nPopulation > 4 or GameRules.elapsedTime > 10*60)
end
