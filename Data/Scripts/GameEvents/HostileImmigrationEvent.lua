...
function HostileImmigrationEvent.allowEvent(nPopulation, nElapsedTime)
    return not g_Config:getConfigValue('disable_hostile_events') and not g_Config:getConfigValue('disable_hostiles') and (nPopulation > 6 or GameRules.elapsedTime > 60*12)
end
